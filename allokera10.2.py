...
förbättrad HIB‑koppling, robust kolumnmatchning och ett förenklat GUI för filuppladdning:
  ...
  * Indata‑filvalet använder nu tydliga statusrutor med text ("Uppladdad" med
    grön bakgrund respektive "Ej fil" med grå bakgrund) samt en röd
    borttagningsknapp. Drag‑och‑släpp‑zonen kan även klickas för att välja
